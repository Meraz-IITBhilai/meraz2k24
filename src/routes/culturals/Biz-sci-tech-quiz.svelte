...
<svelte:head>
	<title>Biz sci tech quiz| Meraz '22</title>
...
<div class="bodyy">
    ...
    <div class="main-container">
        <div class="poster-container">
            <img alt="not found" class="poster1" src="/assets/poster/bizscitech.png"  border="0">
        </div>
        <div class="text-container">
            ...
            <div class="description">
                <div class="description-container">
                    <p>
                        If you are interested in the new buzz in the stock market or which <br> new latest breakthrough is making the rounds in the tech community ,then this <br> event is for you. As the name suggests you would be asked questions based <br> on various topics related to business, science and technology. So go on register, and get anything and everything from <br> the world of cryptos to bullish markets to Metaverse and NFTs to self-driving cars and what not!</p>
                </div>
            ...
            <div class="details-container">
                ...
                <div class="poc-col">
                    ...
                    Piyush Pancholi: +91 9340595655 <br>
                    Avula Hari: +91 76749849421<br>
                    </div>
            </div>
