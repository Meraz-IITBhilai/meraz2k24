...
<div class="bodyy">
    ...
    <div class="main-container">
        <div class="poster-container">
            <img alt="not found" class="poster1" src="/assets/poster/photostory.png"  border="0">
        </div>
        <div class="text-container">
            ...
            <div class="description">
                <div class="description-container">
                    <p>
                        The Pixel Snappers presents Photo story as a part of Meraz, <br> the annual techno-cultural fest of IIT Bhilai. The participants have to post a photo clicked <br> by them during the fest on social media platform with the hashtags- #meraz #iitbhilai #thepixelsnappers. The hashtags are compulsory for it to be a valid submission.</p>
                </div>
            ...
            <div class="details-container">
                ...
                <div class="poc-col">
                    ...
                    Ankita Awasthi: +91 9920680947 <br>
                    Aayush Kataria: +91 8169932210<br>
