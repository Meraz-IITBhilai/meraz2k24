		...
		<div class="text-container">
			...
			<div class="description">
				<div class="description-container">
					<p>
						7 Up & 7 Down is a classic poker game. 7 Up & 7 Down is one of the best poker game to
						play. Simply bet and guess the card is it high or low and you could win double. Score
						more and more and you might be lucky to be featured on our scoreboard.
					</p>
				</div>
